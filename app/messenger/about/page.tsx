...
export default function MessengerAboutPage() {
    ...
    <main className="min-h-screen" style={{ background: vivosTheme.gradients.appBackground }}>
        ...
        <div className="mx-auto flex min-h-[72px] max-w-3xl items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-lg font-semibold text-white">Despre</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-3xl px-4 py-5">
        <Card className="rounded-3xl border-0 shadow-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-xl"><Info className="h-5 w-5" />Despre VIVOS Messenger</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 text-sm text-slate-600">
            <p>Messenger este spațiul independent de conversație al ecosistemului VIVOS: mesaje private, apeluri audio și video, într-o interfață separată de restul platformei.</p>
