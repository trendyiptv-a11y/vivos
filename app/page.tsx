              ...
              <div key={i} className="rounded-2xl border p-4">
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  ...
                  <div className="grid gap-2 text-sm text-slate-600 md:text-right">
                    <p>
                      Reputație: <span className="font-medium text-slate-900">{member.reputation}</span>
                    </p>
                    <p>
                      Contribuție: <span className="font-medium text-slate-900">{member.contribution} talanți</span>
                    </p>
                    <p>
                      Nevoie: <span className="font-medium text-slate-900">{member.needs}</span>
                    </p>
                  </div>
                </div>
                <div className="mt-4 flex flex-wrap gap-2">
                  <Button variant="outline" className="rounded-2xl">Vezi profil</Button>
                  <Button variant="outline" className="rounded-2xl">Propune schimb</Button>
                  <Button variant="outline" className="rounded-2xl">Trimite mesaj</Button>
                </div>
              </div>
            ))}
          </CardContent>
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="rounded-2xl">Publică cerere</Button>
      ...
      <Card className="rounded-3xl border-0 shadow-sm">
        ...
        <CardContent>
          <div className="mb-6 rounded-3xl bg-slate-900 p-6 text-white">
            ...
            <p className="mt-3 text-sm text-slate-300">Valoare oferită, primită și recunoscută în comunitate.</p>
          </div>
    ...
    <div className="space-y-6">
      <Card className="rounded-3xl border-0 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button variant="outline" className="rounded-2xl">Încarcă document</Button>
        </CardHeader>
        <CardContent className="space-y-3">
          {archiveItems.map((item, i) => (
            <div key={i} className="flex flex-col gap-3 rounded-2xl border p-4 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="font-medium">{item.title}</p>
                <p className="text-sm text-slate-500">{item.type} · {item.date}</p>
              </div>
              <div className="flex gap-2">
                <Button variant="outline" className="rounded-2xl">Vezi</Button>
                <Button variant="outline" className="rounded-2xl">Hash</Button>
              </div>
            </div>
          ))}
        </CardContent>
