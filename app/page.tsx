...
type ShellProps = {
  ...
  unreadCount: number
  showPublicPulse: boolean
}

function Shell({ active, setActive, children, userEmail, unreadCount, showPublicPulse }: ShellProps) {
  const showUnreadBadge = !!userEmail && unreadCount > 0
  const showLiveBadge = !userEmail && showPublicPulse
            ...
            <div className="flex items-center justify-between gap-4 px-6 py-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  {showLiveBadge && (
                    <div className="absolute -right-2 -top-2 flex h-6 min-w-6 items-center justify-center rounded-full bg-emerald-600 px-2 text-[10px] font-semibold tracking-wide text-white">
                      LIVE
                    </div>
                  )}
                </div>
...
export default function Page() {
  ...
  const [showPublicPulse, setShowPublicPulse] = useState(true)
  ...
  }, [active, members, membersLoading, userEmail, marketPosts])
  ...
  return (
    <Shell
      ...
      showPublicPulse={showPublicPulse}
    >
      {screen}
    </Shell>
  )
