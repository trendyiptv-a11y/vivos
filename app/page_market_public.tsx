        ...
        <CardContent className="space-y-3">
          {marketPosts.length === 0 ? (
            <div className="rounded-2xl border p-4 text-sm text-slate-600">
              Piața este deschisă. Primele postări vor apărea aici pe măsură ce comunitatea începe să le publice.
            </div>
          ) : (
    ...
    <div className="space-y-6">
      ...
      <Card className="rounded-3xl border-0 shadow-sm">
        ...
        <CardContent className="space-y-3">
          {marketPosts.length === 0 ? (
            <div className="rounded-2xl border p-4 text-sm text-slate-600">
              Piața este publică și vizibilă tuturor. Primele postări vor apărea aici pe măsură ce comunitatea începe să le publice.
            </div>
          ) : (
            marketPosts.map((item) => (
              <div
