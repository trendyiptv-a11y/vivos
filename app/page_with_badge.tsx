...
function Shell({ active, setActive, children, userEmail, unreadCount }: ShellProps) {
  return (
...
export default function Page() {
  ...
  return (
    <Shell active={active} setActive={setActive} userEmail={userEmail} unreadCount={unreadCount}>
      {screen}
    </Shell>
  )
}
